...
class Widget extends \WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct( 'wpr-widget', esc_html__( 'Recent Portfolio Items List', $this->plugin_slug ), $widget_ops );
	}
	...
	public function widget( $args, $instance ) {
		...
		$object = array(
			...
			'siteurl'			=>	is_ssl() ? str_replace( 'http://', 'https://', get_option('siteurl') ) : get_option('siteurl'),
		);

		wp_localize_script( $this->plugin_slug . '-widget-script', 'vars', $object );
